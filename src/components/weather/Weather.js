                ...
                <div className='col-md-6'>
                    <div className='card text-center bg-light text-dark'>
                        ...
                        <div className='card-footer'>
                            <button className='btn btn-sm btn-primary font-weight-bold' onClick= {clickSunny}>Sunny</button>
                            <button className='btn btn-sm btn-secondary font-weight-bold' onClick= {clickRainy}>Rainy</button>
                            <button className='btn btn-sm btn-warning font-weight-bold 'onClick= {clickCloudy}>Cloudy</button>
                            <button className='btn btn-sm btn-success font-weight-bold'onClick= {clickSnowy}>Snowy</button>
